...
const main = async (parent) => {
  ...
  const url2 = "./emergencytransport_difficult_all.csv";
  ...
  const config = {
    data: {
      ...
      datasets: [
        ...
        { type: "line", label: "PCR 検査陽性者数", hidden: true, data: data1, borderColor: 'rgb(255, 99, 132)', fill: false, lineTension: 0, yAxisID: "yl" },
        // { type: "line", label: "死亡者数", data: data_dd, borderColor: 'rgb(10, 10, 12)', fill: false, lineTension: 0, yAxisID: "yl" },
        { type: "line", label: "累計死亡者数", hidden: true, data: data_d, borderColor: 'rgb(10, 10, 12)', fill: false, lineTension: 0, yAxisID: "yl" },
